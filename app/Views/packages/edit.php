...
<div class="row">
    <div class="col-md-8 offset-md-2">
        <div class="card">
            ...
            <div class="card-body">
                <?= form_open('admin/packages/edit/' . $package['id'], ['id' => 'packageForm']) ?>
                    <?= csrf_field() ?>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select <?= isset($errors['package_type']) ? 'is-invalid' : '' ?>" 
                                ...
                                <option value="prepaid" <?= old('package_type', $package['package_type']) == 'prepaid' ? 'selected' : '' ?>>Prepaid</option>
                                <option value="postpaid" <?= old('package_type', $package['package_type']) == 'postpaid' ? 'selected' : '' ?>>Postpaid</option>
                                <option value="hotspot" <?= old('package_type', $package['package_type']) == 'hotspot' ? 'selected' : '' ?>>Hotspot</option>
                                <option value="pppoe" <?= old('package_type', $package['package_type']) == 'pppoe' ? 'selected' : '' ?>>PPPoE</option>
                            </select>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control <?= isset($errors['download_speed']) ? 'is-invalid' : '' ?>" 
                                   id="download_speed" name="download_speed" value="<?= old('download_speed', $package['download_speed']) ?>" required min="1">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control <?= isset($errors['upload_speed']) ? 'is-invalid' : '' ?>" 
                                   id="upload_speed" name="upload_speed" value="<?= old('upload_speed', $package['upload_speed']) ?>" required min="1">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="tax_percentage" name="tax_percentage" 
                                   value="<?= old('tax_percentage', $package['tax_percentage']) ?>" min="0" step="0.01">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="bandwidth_limit" name="bandwidth_limit" 
                                   value="<?= old('bandwidth_limit', $package['bandwidth_limit']) ?>" min="0">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control <?= isset($errors['valid_days']) ? 'is-invalid' : '' ?>" 
                                   id="valid_days" name="valid_days" value="<?= old('valid_days', $package['valid_days']) ?>" required min="1">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="radius_group" name="radius_group" 
                                   value="<?= old('radius_group', $package['radius_group']) ?>" placeholder="e.g., 10mb_package">

...
<div class="row">
    <div class="col-md-8 offset-md-2">
        <div class="card">
            ...
            <div class="card-body">
                <?= form_open('admin/routers/create', ['id' => 'routerForm']) ?>
                    <?= csrf_field() ?>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control <?= isset($errors['router_name']) ? 'is-invalid' : '' ?>" 
                                   id="router_name" name="router_name" value="<?= old('router_name') ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select <?= isset($errors['router_type']) ? 'is-invalid' : '' ?>" 
                                ...
                                <option value="mikrotik" <?= old('router_type') == 'mikrotik' ? 'selected' : '' ?>>MikroTik</option>
                                <option value="cisco" <?= old('router_type') == 'cisco' ? 'selected' : '' ?>>Cisco</option>
                                <option value="ubiquiti" <?= old('router_type') == 'ubiquiti' ? 'selected' : '' ?>>Ubiquiti</option>
                                <option value="other" <?= old('router_type') == 'other' ? 'selected' : '' ?>>Other</option>
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="port" name="port" 
                                   value="<?= old('port', '8728') ?>" placeholder="8728">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="username" name="username" 
                                   value="<?= old('username') ?>" placeholder="admin">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="location" name="location" 
                                   value="<?= old('location') ?>" placeholder="Head Office">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="api_token" name="api_token" 
                               value="<?= old('api_token') ?>" placeholder="For MikroTik API token">
                        <small class="text-muted">Use instead of username/password for MikroTik API</small>
                    </div>
